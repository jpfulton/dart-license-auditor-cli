...
const repositoryUrl = "https://github.com/jpfulton/dart-license-auditor-cli";
...
/**
 * DangerJS plugin to audit licenses of dependencies in a Dart project.
 *
 ...
 */
export const dartLicenseAuditor = async (
  ...
  try {
    ...
    if (showMarkdownSummary) {
      ...
      markdown(
        `> :information_source: This summary is generated by \`dart-license-auditor-cli\` plugin for DangerJS. <br />
...
> :information_source: For more information, please visit [dart-license-auditor-cli](${repositoryUrl}) <br />`
      );
    ...
    fail(
      `[dart-license-auditor-cli] Failed to audit licenses with error: ${
...
export default dartLicenseAuditor;
